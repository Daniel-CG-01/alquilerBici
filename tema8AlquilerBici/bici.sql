...
CREATE TABLE `bici` (
  ...
  CONSTRAINT `fk_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`idusuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `bici` VALUES (1,0),(2,0);
...
INSERT INTO `usuario` VALUES (0,'libre',0,'0'),(1,'pepe',30,'11223344556677889977');
...
-- Dump completed on 2025-03-24 13:56:46
